package com.blogspot.wengki.app12141432;

import java.util.Scanner;

    public class app12141432 {
    String nama;
    byte level = 1;
    byte kesempatan = 5;
    short tebak;
    ...
    public void Score() {
        ...
        System.out.println("susanti\t: 70");
        System.out.println("merdin\t: 50");
        System.out.println("sunai\t: 100");
        System.out.println("mu'as\t: 100");
    }
    
    public static void main(String[] args) {
        app12141432 main = new app12141432();
